drop table sym_notification;
drop table sym_monitor;
drop table sym_extension;
drop table sym_file_trigger_router;
drop table sym_file_trigger;
drop table sym_trigger_router_grouplet;
drop table sym_grouplet_link;
drop table sym_grouplet;
...
drop table sym_extract_request;
drop table sym_file_incoming;
drop table sym_file_snapshot;
drop table sym_incoming_batch;
drop table sym_incoming_error;
drop table sym_lock;
drop table sym_monitor_event;
...
drop table sym_table_reload_request;
