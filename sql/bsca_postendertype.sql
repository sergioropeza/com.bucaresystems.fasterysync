CREATE TABLE bsca_postendertype (
	...
	CONSTRAINT bsca_postendertype_fk FOREIGN KEY (bsca_currency_id) REFERENCES bsca_currency(id)
);
CREATE INDEX bsca_postendertype_fk ON bsca_postendertype USING btree (bsca_currency_id);